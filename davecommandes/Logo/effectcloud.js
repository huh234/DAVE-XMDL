module.exports = async (context) => {
  ...
  if (!text || text.trim() === '') {
    return m.reply(`◈━━━━━━━━━━━━━━━━◈\n│❒ Yo, brain-dead moron, give me some text for the Effect Clouds logo! Use *!effectclouds SomeText* or fuck off! 😡`);
  }
  ...
  try {
    ...
    if (data && data.success && data.result && data.result.image_url) {
      const caption = `◈━━━━━━━━━━━━━━━━◈\n│❒ Here’s your damn *Effect Clouds* logo, ${m.pushName}! Don’t waste my time again, you airy prick! 😤\n` +
                     `📸 *Text*: ${cleanedText}\n` +
      ...
      await m.reply(`◈━━━━━━━━━━━━━━━━◈\n│❒ API’s being a bitch, no Effect Clouds logo for you, loser
