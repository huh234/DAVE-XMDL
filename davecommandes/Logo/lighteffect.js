module.exports = async (context) => {
  ...
  if (!text || text.trim() === '') {
    return m.reply(`◈━━━━━━━━━━━━━━━━◈\n│❒ Yo, brain-dead moron, give me some text for the Light Effect logo! Use *!lighteffect SomeText* or fuck off! 😡`);
  }
  ...
  try {
    ...
    if (data && data.success && data.result && data.result.image_url) {
      const caption = `◈━━━━━━━━━━━━━━━━◈\n│❒ Here’s your damn *Light Effect* logo, ${m.pushName}! Don’t waste my time again, you dim-witted prick! 😤\n` +
                     `📸 *Text*: ${cleanedText}\n` +
      ...
      await m.reply(`◈━━━━━━━━━━━━━━━━◈\n│❒ API’s being a bitch, no Light Effect logo for you, loser! Try again later. 😒`);
    }
  } catch (error) {
