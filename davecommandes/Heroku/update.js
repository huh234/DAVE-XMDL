...
module.exports = async (context) => {
    ...
    await ownerMiddleware(context, async () => {
        ...
        try {
            ...
            const repoUrl = "https://api.github.com/repos/huh234/DAVE-XD/commits/main";
            ...
            const { data: zipData } = await axios.get("https://github.com/huh234/DAVE-XD/archive/main.zip", {
